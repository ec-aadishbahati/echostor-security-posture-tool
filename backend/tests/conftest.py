...
from app.core.database import Base, get_write_db, get_read_db
from app.core.security import get_password_hash, create_access_token
from app.models.user import User
from app.models.assessment import Assessment, AssessmentResponse as AssessmentResponseModel, Report
...
def admin_token(test_admin_user):
    return create_access_token(
        data={"sub": test_admin_user.email, "user_id": str(test_admin_user.id), "is_admin": True},
        is_admin=True
    )
